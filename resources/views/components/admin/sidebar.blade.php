        ...
        <ul class="space-y-2">
            <li>
                <x-admin.nav-link href="/admin" :active="request()->is('admin')">
                    <svg class="w-6 h-6 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        :class="{ 'text-gray-900': active, 'text-gray-500': !active }" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
                        <path fill-rule="evenodd" d="M11.293
                        3.293a1 1 0 0 1 1.414 0l6 6 2 2a1 1 0 0 1-1.414 1.414L19 12.414V19a2 2 0 0 1-2 2h-3a1 1 0 0
                        1-1-1v-3h-2v3a1 1 0 0 1-1 1H7a2 2 0 0 1-2-2v-6.586l-.293.293a1 1 0 0 1-1.414-1.414l2-2 6-6Z"
                            clip-rule="evenodd" />
                    </svg>
            ...
            <li>
                <x-admin.nav-link href="/admin/reports" :active="request()->is('admin/reports')">
                    <svg class="w-6 h-6  transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        :class="{ 'text-gray-900': active, 'text-gray-500': !active }"aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
            ...
            <li>
                <x-admin.nav-link href="/admin/articles" :active="request()->is('admin/articles')">
                    <svg class="w-6 h-6 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                        :class="{ 'text-gray-900': active, 'text-gray-500': !active }"aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                        viewBox="0 0 24 24">
            ...
            <li>
                <x-admin.nav-link href="/admin/educations" :active="request()->is('admin/educations')">
